...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
          ...
          if (response.status === 200) {
              ...
              // For error responses, the data might also be in response.data
              console.error('Form submission failed:', response.data);
              setSubmissionError(response.data?.message || 'Something went wrong. Please try again.');
          }
      } catch (error) {
    ...
    return (
        <motion.div
            className="bg-gradient-to-br from-gray-100 to-gray-200  py-12 px-4 sm:px-6 lg:px-8 pt-25"
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-center gap-4">
                                ...
                                <p className="text-indigo-100">
                                    Email: <a href="mailto:easysheetsofficial@gmail.com" className="font-semibold hover:underline">easysheetsofficial@gmail.com</a>
                                </p>
                            </div>
                            <div className="flex items-center justify-center gap-4">
                                <MapPinIcon className="h-6 w-6 text-yellow-300" />
                                <p className="text-indigo-100">
                                    Address: CIT Kokrajhar, Assam, 783370
                                </p>
                            </div>
                            <div className="flex items-center justify-center gap-4">
