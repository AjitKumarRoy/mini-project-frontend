    ...
    <div className="flex flex-col bg-gradient-to-br from-gray-100 to-gray-200 pt-10">
      ...
      {activeTab === "view" && (
        <div
          ...
          className="mt-4 bg-white p-4 max-h-[400px] overflow-y-auto"
        >
          {loading ? (
            ...
            <div className="p-4 bg-white shadow rounded-lg">
              ...
              <input
                ...
                onChange={(e) =>
                  setColumnCount(parseInt(e.target.value, 10) || 0)
                }
              />
              {columnCount > 0 && (
                <div>
                  ...
                  {sheetData.slice(1).map((row, rowIdx) => (
                    <tr key={rowIdx} className="even:bg-gray-50">
                      ...
                      {row.map((cell, colIdx) => (
                        <td
                          key={colIdx}
                          className="border text-center p-3 min-w-[80px] sm:min-w-[150px] max-w-[200px] overflow-hidden"
                        >
                          <div className="w-24 sm:w-40 overflow-x-auto whitespace-nowrap">
                            {cell}
                          </div>
                        </td>
                      ))}
